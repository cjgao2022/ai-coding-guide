...
Agent teams 就是把你从「亲自下场的工人」变成「指挥若定的工头」。它适用在三类活儿上（官方点名的「最强用例」）：
...
下一篇 **30「功能决策表：什么时候用哪个」**——到这篇为止，`CLAUDE.md`、Skill、Hook、MCP、Subagent、Agent teams，Claude Code 的招式你已经学了一大摞。但学得多不等于用得对，真正难的是临到一个具体需求，**到底该掏哪一个？** 下一篇我给你一张决策表，把这些功能的「适用边界」摆到一张纸上——看完你就再不会对着一个需求犯「该用啥」的选择困难症了。
